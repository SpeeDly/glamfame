...
function show_image(src){
    $("body").append('<div id="img_container"><div class="forms crop_me"><a href="javascript:;" class="close_white_window"></a><div class="text">Please drag the circle around your face and save your selection</div><img style="width: 100%; height: auto;" id="img_crop" src='+src+' style="position: relative;"></img><input type="button" class="custom_button" onclick="clear_all()" value="Save selection"></div></div>');
...
$('li.nav.crop').click(function(){
    ...
    {
        $("body").append('<div id="img_container" class="second"><div class="forms crop_me"><a href="javascript:;" class="close_white_window"></a><div class="text">Please drag the circle around your face and save your selection</div><img style="width: 100%; height: auto;" id="img_crop" src='+img_src+' style="position: relative;"></img><input type="button" class="custom_button" onclick="clear_all()" value="Save selection"></div></div>');
...
$('body').on("click", ".close_white_window",function(){
    clear_all();
});