    ...
    function testAPI() {
        FB.api('/me', function(response) {
            ...
            FB.api('/me/picture', {"redirect": false, "height": "160", "type": "normal", "width": "160"}, function(response) {
                ...
                .fail(function(){
                    $(".login ul:eq(0)").before('<ul class="errorlist"><li><ul class="errorlist"><li>This facebook profile is already used</li></ul></li></ul>');
                });
            });
        });
    }
    ...
    function testAPI() {
        FB.api('/me', function(response) {
            ...
            FB.api('/me/picture', {"redirect": false, "height": "160", "type": "normal", "width": "160"}, function(response) {
                ...
                .fail(function(){
                    $("#form_1 ul:eq(0)").before('<ul class="errorlist"><li><ul class="errorlist"><li>You have to sign up, using your Facebook profile first</li></ul></li></ul>');
                });
