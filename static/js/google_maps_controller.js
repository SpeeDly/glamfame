...
function success(position) {
    ...
    function(){
        $.getJSON('https://maps.googleapis.com/maps/api/geocode/json?latlng=' + marker.getPosition().lat() +
    ...
    function placeMarker(location) {
        ...
        link = 'https://maps.googleapis.com/maps/api/geocode/json?latlng=' + marker.getPosition().lat() + ',' + marker.getPosition().lng() + '&sensor=false';
...
{
    $.getJSON(
        'https://maps.googleapis.com/maps/api/geocode/json?latlng=' + position.latitude +
...
function fail(){
    ...
    $('#id_post_code').keyup(function(){
        ...
        if($this.length == 5){
            link = 'https://maps.googleapis.com/maps/api/geocode/json?address=' + $this + '&sensor=false';
            $.getJSON(link, function(data){
